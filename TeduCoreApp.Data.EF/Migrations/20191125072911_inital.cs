        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: true),
                    AdvertistmentPageId = table.Column<string>(nullable: true),
                    AdvertistmentPositionId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertistmentPositions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdvertistmentPositions_AdvertistmentPages_AdvertistmentPageId",
                        column: x => x.AdvertistmentPageId,
                        principalTable: "AdvertistmentPages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AdvertistmentPositions_AdvertistmentPositions_AdvertistmentPositionId",
                        column: x => x.AdvertistmentPositionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertistmentPositions_AdvertistmentPageId",
                table: "AdvertistmentPositions",
                column: "AdvertistmentPageId");

            migrationBuilder.CreateIndex(
                name: "IX_AdvertistmentPositions_AdvertistmentPositionId",
                table: "AdvertistmentPositions",
                column: "AdvertistmentPositionId");
